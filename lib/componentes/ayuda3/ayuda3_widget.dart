...
import 'ayuda3_model.dart';
export 'ayuda3_model.dart';

class Ayuda3Widget extends StatefulWidget {
  const Ayuda3Widget({Key? key}) : super(key: key);

  @override
  _Ayuda3WidgetState createState() => _Ayuda3WidgetState();
}

class _Ayuda3WidgetState extends State<Ayuda3Widget> {
  late Ayuda3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Ayuda3Model());
  }
