...
import 'ayuda1_model.dart';
export 'ayuda1_model.dart';

class Ayuda1Widget extends StatefulWidget {
  const Ayuda1Widget({Key? key}) : super(key: key);

  @override
  _Ayuda1WidgetState createState() => _Ayuda1WidgetState();
}

class _Ayuda1WidgetState extends State<Ayuda1Widget> {
  late Ayuda1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Ayuda1Model());
  }
