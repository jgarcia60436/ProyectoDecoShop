...
export 'productos_admin_model.dart';

class ProductosAdminWidget extends StatefulWidget {
  const ProductosAdminWidget({
    Key? key,
    this.productosRef,
  }) : super(key: key);
  ...
  @override
  _ProductosAdminWidgetState createState() => _ProductosAdminWidgetState();
}

class _ProductosAdminWidgetState extends State<ProductosAdminWidget>
    with TickerProviderStateMixin {
  late ProductosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductosAdminModel());
  }
