...
import 'e_empleado_model.dart';
export 'e_empleado_model.dart';

class EEmpleadoWidget extends StatefulWidget {
  const EEmpleadoWidget({
    Key? key,
    this.empleadoP,
    this.nombreP,
    this.direccionP,
  ...
  final DocumentReference? empleadoP;
  final String? nombreP;
  final String? direccionP;
  final int? telefonoP;

  @override
  _EEmpleadoWidgetState createState() => _EEmpleadoWidgetState();
}

class _EEmpleadoWidgetState extends State<EEmpleadoWidget> {
  late EEmpleadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EEmpleadoModel());
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            if (functions.validarCampos(
                                              ...
                                              await widget.empleadoP!
                                                  .update(empleadosUpdateData);
