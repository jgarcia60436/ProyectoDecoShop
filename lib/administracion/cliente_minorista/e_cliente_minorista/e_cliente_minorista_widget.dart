...
import 'e_cliente_minorista_model.dart';
export 'e_cliente_minorista_model.dart';

class EClienteMinoristaWidget extends StatefulWidget {
  const EClienteMinoristaWidget({
    Key? key,
    this.clienteP,
    this.nombreP,
    this.direccionP,
  ...
  @override
  _EClienteMinoristaWidgetState createState() =>
      _EClienteMinoristaWidgetState();
}

class _EClienteMinoristaWidgetState extends State<EClienteMinoristaWidget> {
  late EClienteMinoristaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EClienteMinoristaModel());
              ...
              if ('' == '4')
                StreamBuilder<List<ClientesRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ClientesRecord> rowClientesRecordList = snapshot.data!;
                    return Row(
                      mainAxisSize: MainAxisSize.max,
                      children: List.generate(rowClientesRecordList.length,
                          (rowIndex) {
                        final rowClientesRecord =
                            rowClientesRecordList[rowIndex];
                        return Text(
                          ' ',
