...
import 'a_cliente_minorista_model.dart';
export 'a_cliente_minorista_model.dart';

class AClienteMinoristaWidget extends StatefulWidget {
  const AClienteMinoristaWidget({Key? key}) : super(key: key);

  @override
  _AClienteMinoristaWidgetState createState() =>
      _AClienteMinoristaWidgetState();
}

class _AClienteMinoristaWidgetState extends State<AClienteMinoristaWidget> {
  late AClienteMinoristaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AClienteMinoristaModel());
