...
class AdministracionWidget extends StatefulWidget {
  const AdministracionWidget({Key? key}) : super(key: key);

  @override
  _AdministracionWidgetState createState() => _AdministracionWidgetState();
}
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 20.0, 0.0, 0.0),
                                              child: Text(
                                                'Bienvenido a la seccion de administracion del sistema, por favor seleccione una opcion antes de continuar:',
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () async {
                            context.pushNamed('ClientesMinoristas');
                          },
                          child: Container(
                            width: 150.0,
                            height: 40.0,
