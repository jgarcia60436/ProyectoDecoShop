...
class PagoWidget extends StatefulWidget {
  ...
  final DocumentReference? carritoLista;
          ...
          child: Padding(
            ...
            child: FutureBuilder<ApiCallResponse>(
              ...
              builder: (context, snapshot) {
                ...
                final columnApiTipoCambioResponse = snapshot.data!;
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 10.0, 0.0),
                              child: Text(
                                ApiTipoCambioCall.fecha(
                                  columnApiTipoCambioResponse.jsonBody,
                                ).toString(),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Lottie.asset(
                              'assets/lottie_animations/1758-credit-card.json',
                              width: 150.0,
                              height: 130.0,
                              fit: BoxFit.cover,
                              animate: true,
                                  ...
                                  TextSpan(
                                    text: functions
                                        .dolarizacion(
                                            ...
                                            ApiTipoCambioCall.venta(
                                              columnApiTipoCambioResponse
                                                  .jsonBody,
                                            ))
                                        .toString(),
                                    style: TextStyle(),
